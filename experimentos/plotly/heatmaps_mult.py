...
df1 = pd.read_csv('dados/2010SitkaAK.csv')
df2 = pd.read_csv('dados/2010SantaBarbaraCA.csv')
df3 = pd.read_csv('dados/2010YumaAZ.csv')
...
pyo.plot(fig, filename='HTML/heatmaps_mult.html') 